    ...
    async function loadModel() {
      try {
        ...
        const session = await ort.InferenceSession.create("/ultraface.onnx", {
          executionProviders: ["wasm", "webgpu", "webgl"],
          numThreads: 1,
        });
      ...
      <div className="container">
        <div className="description">
          ...
          <p>
            ...
            The model is loaded using ONNX Runtime Web and executed on the GPU using WebGPU, if you
            are using firefox browser webgl is not supported so the model will be executed on the
            CPU.
          </p>
        </div>
        <div className="stats">
