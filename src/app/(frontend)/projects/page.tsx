  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <Link href="/projects/unet-segmentation" className="block group">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 transition-transform duration-300 group-hover:scale-105 group-hover:shadow-lg">
            <div className="flex items-center mb-4">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-1">U-Net Segmentation</h3>
                <span className="inline-block bg-pink-100 text-pink-800 text-xs px-2 py-1 rounded-full">Image Segmentation</span>
              </div>
            </div>
            <p className="text-gray-600 dark:text-gray-300 mb-4">
            ...
            <div className="flex flex-wrap gap-2">
              <span className="bg-pink-100 text-pink-800 text-xs px-2 py-1 rounded">U-Net</span>
              <span className="bg-purple-100 text-purple-800 text-xs px-2 py-1 rounded">Computer Vision</span>
              <span className="bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded">WebGPU</span>
            </div>
          </div>
        </Link>
