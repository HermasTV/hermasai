...
export default function ContactPage() {
  ...
  useEffect(() => {
    // Preload images
    const imageUrls = [
      'https://i.ibb.co/0yWyb0q/360-F-557185071-VIBFy-Ig-Ff-Fyt-Hnk-Lvmplkb-Di-Ow-Fe0c8n.jpg',
      'https://i.ibb.co/znHTqbB/Whats-App-Image-2024-03-06-at-12-14-19-0814d8ff.jpg',
      'https://www.davidbernie.com/wp-content/uploads/2023/11/David-Bernie-Wallpaper-Free-Palestine-Watermelon-I-Desktop-3456x2234-1-scaled.jpg'
    ];
  ...
  useEffect(() => {
    if (!isLoaded) return; // Wait for page to load before adding event listeners
    ...
    <>
      ...
      * {
      ...
      .card-cover {
        ...
        transition: 0.5s;
        opacity: 0;
        animation: fadeInCover 0.5s ease-in-out 0.3s forwards;
      }
      ...
      .card-avatar {
        ...
        opacity: 0;
        animation: fadeInAvatar 0.5s ease-in-out 1s forwards;
        max-width: 100px;
        max-height: 100px;
        display: block;
      }
          ...
          <div className="card-section is-active" id="about">
            <div className="card-content">
              ...
              <p className="card-desc">
                a passionate geek who loves to code and build things, using this platform to share
                my demo projects and experiments with the world.
              </p>
            </div>
